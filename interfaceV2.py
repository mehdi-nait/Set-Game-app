...
class App:
     def __init__(self, window, window_title, video_source=0):
        ...
        # Creation des elements de la fenetre
         ...
         imageInitiale = tkinter.PhotoImage(file="/home/pi/Desktop/Modèles/cartes/1-green-striped-squiggle.jpg").zoom(32).subsample(64)
         '''global canvas2
         ...
         def rafraichir():
             ...
             #cardName = "roi.png"
             imageCarte = tkinter.PhotoImage(file="/home/pi/Desktop/Modèles/cartes"+cardName+".jpg")
